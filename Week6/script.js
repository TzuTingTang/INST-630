...
document.addEventListener('DOMContentLoaded', function() {
    ...
    filterButton.addEventListener('click', function() {
        ...
        let html = `<p><strong>Found ${cheapRestaurants.length} affordable restaurants:</strong></p>`;
